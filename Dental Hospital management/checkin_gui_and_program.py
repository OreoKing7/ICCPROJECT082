...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        self.Label6.configure(text='''CHOOSE YOUR OP ROOM''')
        ...
        self.Checkbutton1.configure(text='''SCALING''')
        ...
        self.Checkbutton2.configure(text='''ROOT CANAL''')
        ...
        self.Checkbutton4.configure(text='''EXTRACTION''')
