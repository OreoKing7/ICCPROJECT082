...
def chk_add():
    while True:
        print("\n")
        address = input("ENTER PATEIENT ADDRESS:")
        a = address.isdigit()
...
def chk_day():
    while True:
        print("\n")
        no_of_days = input("ENTER NO OF TEETH TO BE TREATED (100 means all):")
...
def chk_pay():
    while True:
        print("\n")
        op = input("Enter patients's choice:")
        a = op.isdigit()
...
class save:
    ...
    def bill(self):
        print("\n")
        print("@@@@@@@@@  Bahria dental hospital  @@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@ Saving the smiles since @@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@    ###2012###       @@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
...
while True:
    ...
    print("3.Check out")
    print("4.get info of any patient")
    print("5.EXIT")
    ...
    if k == "1":
        ...
        print("\n")
        while True:
            a = input("ENTER OPERATING ROOM NO.")
            if len(a) != 0:
                break
            else:
            ...
            v = int(a)
        v = int(a)
        f = open("dental_hos.dat", "rb")
        f1 = open("dental_hos.dat", "ab")
        n = 0
        try:
            while True:
                s = pickle.load(f)
        ...
        f.close()
        f1.close()
        os.remove("dental_hos.dat")
        os.rename("dental_hos.dat", "dental_hos.dat")
