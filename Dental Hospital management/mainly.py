...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        root.title("DENTAL HOSPITAL RESERVATION")
        ...
        self.Button2.configure(text='''1.RESERVATION''')
        ...
        self.Button3.configure(text='''2.SHOW PATIENT LIST''')
        ...
        self.Button4.configure(text='''3.CALCULATE BILL''')
        ...
        self.Button5.configure(text='''4.GET INFO OF ANY PATIENT''')
